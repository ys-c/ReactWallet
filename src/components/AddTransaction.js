...
import { Input, Select, Option, FormControl, FormLabel, Button, FormHelperText } from '@mui/joy';
            ...
            <div className="add-transcation-container">
                <FormControl >
                    ...
                    <Input size="lg"
                        ...
                        required />
                    {validAmount === 'true' ? '' : <FormHelperText> Oops! Please enter valid positive number. </FormHelperText>}
